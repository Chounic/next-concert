...
export default function Index(props: any) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className='sm:text-2xl py-8 pl-12 lg:pl-28 '>Tous les artistes du moment</div>
      <div className='overflow-hidden group relative sm:px-10'>
        ...
        <button className="absolute w-10 h-10 bottom-10 sm:bottom-20 sm:opacity-30 transition ease-in-out delay-100 duration-150 group-hover:opacity-70 left-0" onClick={scrollPrevAttractions}>
          <Image src={anglePetitGauche} alt="next button" className='transition ease-in-out active:scale-75' layout='fill' objectFit='cover' />
        </button>
        <button className="absolute w-10 h-10 bottom-10 sm:bottom-20 opacity-30 transition ease-in-out delay-100 duration-150 group-hover:opacity-70 right-0" onClick={scrollNextAttractions}>
          <Image src={anglePetitDroit} alt="next button" className='transition ease-in-out active:scale-75' layout='fill' objectFit='cover' />
        </button>
      </div>


      <div className='sm:text-2xl pt-16 pb-8 pl-12 lg:pl-28'>Les prochaines dates de concerts à {props.pickedCity}</div>

      <div className='hidden sm:block overflow-hidden group relative'>
