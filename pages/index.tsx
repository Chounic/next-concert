...
export default function Index(props: any) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className='text-2xl py-8 pl-12 lg:pl-28'>Tous les artistes du moment</div>
      ...
      <div className=' text-2xl pt-16 pb-8 pl-12 lg:pl-28'>Les prochaines dates de concerts à {props.pickedCity}</div>
